...
[<p>To run project on EC2 local machine without nginx or other server.</p>](#thirty_eight)
...
<a name="thirty_eight"><h2>To run project on EC2 local machine without nginx or other server.</h2></a><br>
<pre>
